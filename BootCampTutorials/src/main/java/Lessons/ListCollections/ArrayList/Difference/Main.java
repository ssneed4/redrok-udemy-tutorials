package src.main.java.Lessons.ListCollections.ArrayList.Difference;     
...
public class Main {
	...
	public static void main(String[] args) {
        ...
        start = System.currentTimeMillis();
        linkedList.add(10_999_996, 121); // insert 121 at index 5
        System.out.println("LinkedList: " + (System.currentTimeMillis() - start) + "ms");

        start = System.currentTimeMillis();
        arrayList.add(10_999_996, 121);  // insert 121 at index 5
        System.out.println("ArrayList: " + (System.currentTimeMillis() - start) + "ms");
